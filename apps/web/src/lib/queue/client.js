...
export const thumbnailGenerateQueue = new Queue(QUEUE_NAMES.THUMBNAIL_GENERATE, defaultQueueOptions);
 ...
 */
export async function addVideoTranscodeJob(data) {
 ...
 */
export async function addVideoTranscribeJob(data) {
 ...
 */
export async function addThumbnailGenerateJob(data) {
